use colored::*;
use clap::{App, crate_authors, Arg, AppSettings};
...
fn main() {
    ...
    if nmap_str_ports.len() == 0{
        println!("{} Looks like I didn't find any open ports. This is usually caused by using too many threads, or the host not having open ports. I used {} threads, consider lowering to {} with {} or a comfortable number for your system.", "ERROR".red(), threads_str, (threads / 2).to_string().green(), "'rustscan -t <thread_nums> <ip address>'".green());
    }
