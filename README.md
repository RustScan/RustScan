...
| **Version 1.1.0** | **Version 1.1.0** | **Version 1.1.0** | Version 1.0.0 |
...
**Note**: Version 1.1 runs in 8 seconds with batch size 10,000, and is much more stable. I am updating the other packages, but for maximum speed and latest support please use distributions marked with **Version 1.1.0**.
<hr>
